...
// ============================================================================
// FUNCOES DE CARREGAMENTO E ATUALIZACAO
// ============================================================================
...
async function atualizarDados() {
  ...
  try {
    console.log('Disparando atualizacao...');
...
// Chamar carregarTudo ao abrir a pagina
document.addEventListener('DOMContentLoaded', () => {
  console.log('Pagina carregada, iniciando carregamento de dados...');
  carregarTudo();
  
  // Adicionar listener ao botao de atualizar
  const btn = $('#btnAtualizar');
  if (btn) {
